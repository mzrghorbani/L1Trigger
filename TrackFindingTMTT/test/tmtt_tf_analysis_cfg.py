...
#process.CondDB.connect = 'sqlite_file:SLHCUpgradeSimulations/Phase2TrackerDTC/test/OuterTrackerDTCCablingMap.db'
#process.PoolDBESSource = cms.ESSource("PoolDBESSource",process.CondDB,toGet = cms.VPSet(cms.PSet(record = cms.string('OuterTrackerDTCCablingMapRcd'),tag = cms.string("DTCCablingTest"))))

options = VarParsing.VarParsing ('analysis')

#--- Specify input MC
#options.register('inputMC', 'L1Trigger/TrackFindingTMTT/test/MCsamples/937/RelVal/TTbar/PU140.txt',
#options.register('inputMC', 'L1Trigger/TrackFindingTMTT/test/MCsamples/1040/RelVal/TTbar/PU200.txt',
#options.register('inputMC', 'L1Trigger/TrackFindingTMTT/test/MCsamples/1040/RelVal/SingleMuPt2to100/PU0.txt',
#options.register('inputMC', 'L1Trigger/TrackFindingTMTT/test/MCsamples/937/RelVal/SingleMuPt1p5to8/local.txt', 
# Fastest to use a local copy ...
options.register('inputMC', 'L1Trigger/TrackFindingTMTT/test/MCsamples/1040/RelVal/TTbar/localRAL/PU200_ev1.txt',
